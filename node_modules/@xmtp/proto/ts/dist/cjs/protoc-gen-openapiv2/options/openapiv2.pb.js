...
exports.EnumSchema = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        ...
        if (message.externalDocs !== undefined) {
            exports.ExternalDocumentation.encode(message.externalDocs, writer.uint32(50).fork()).ldelim();
        }
        if (message.example !== "") {
        ...
        Object.entries(message.extensions).forEach(([key, value]) => {
            if (value !== undefined) {
                exports.EnumSchema_ExtensionsEntry.encode({ key: key, value }, writer.uint32(74).fork()).ldelim();
            }
        });
        return writer;
    },
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 8:
                    ...
                    break;
                case 9:
                    const entry9 = exports.EnumSchema_ExtensionsEntry.decode(reader, reader.uint32());
                    if (entry9.value !== undefined) {
    ...
    fromPartial(object) {
        ...
        message.ref = (_g = object.ref) !== null && _g !== void 0 ? _g : "";
...
exports.EnumSchema_ExtensionsEntry = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        if (message.key !== "") {
            writer.uint32(10).string(message.key);
        }
