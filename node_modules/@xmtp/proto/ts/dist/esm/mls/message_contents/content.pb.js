...
export function deviceSyncKindFromJSON(object) {
    switch (object) {
        case 0:
...
export function deviceSyncKindToJSON(object) {
    switch (object) {
...
export const PlaintextEnvelope_V2 = {
    encode(message, writer = _m0.Writer.create()) {
        ...
        if (message.userPreferenceUpdate !== undefined) {
            UserPreferenceUpdate.encode(message.userPreferenceUpdate, writer.uint32(42).fork()).ldelim();
        }
        return writer;
    },
    decode(input, length) {
    ...
    fromJSON(object) {
        return {
            ...
            userPreferenceUpdate: isSet(object.userPreferenceUpdate)
                ? UserPreferenceUpdate.fromJSON(object.userPreferenceUpdate)
                : undefined,
        };
    },
    toJSON(message) {
        ...
        message.userPreferenceUpdate !== undefined &&
            (obj.userPreferenceUpdate = message.userPreferenceUpdate
                ? UserPreferenceUpdate.toJSON(message.userPreferenceUpdate)
                : undefined);
        return obj;
    },
    fromPartial(object) {
        ...
        message.userPreferenceUpdate =
            object.userPreferenceUpdate !== undefined &&
                ...
                ? UserPreferenceUpdate.fromPartial(object.userPreferenceUpdate)
                : undefined;
        return message;
    },
};
