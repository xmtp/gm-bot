...
exports.PrivatePreferencesActionMap = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        Object.entries(message.actions).forEach(([key, value]) => {
            exports.PrivatePreferencesActionMap_ActionsEntry.encode({ key: key, value }, writer.uint32(10).fork()).ldelim();
        });
        return writer;
    },
    decode(input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                case 1:
                    const entry1 = exports.PrivatePreferencesActionMap_ActionsEntry.decode(reader, reader.uint32());
                    if (entry1.value !== undefined) {
        ...
        return {
            actions: isObject(object.actions)
                ? Object.entries(object.actions).reduce((acc, [key, value]) => {
                    acc[key] = private_preferences_pb_1.PrivatePreferencesAction.fromJSON(value);
                    return acc;
                }, {})
                : {},
        };
    ...
    toJSON(message) {
        ...
        if (message.actions) {
            Object.entries(message.actions).forEach(([k, v]) => {
                obj.actions[k] = private_preferences_pb_1.PrivatePreferencesAction.toJSON(v);
            });
        }
        return obj;
    },
    fromPartial(object) {
        ...
        message.actions = Object.entries((_a = object.actions) !== null && _a !== void 0 ? _a : {}).reduce((acc, [key, value]) => {
            if (value !== undefined) {
                acc[key] = private_preferences_pb_1.PrivatePreferencesAction.fromPartial(value);
            }
            return acc;
        }, {});
        return message;
...
exports.PrivatePreferencesActionMap_ActionsEntry = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        if (message.key !== "") {
            writer.uint32(10).string(message.key);
        }
        if (message.value !== undefined) {
            private_preferences_pb_1.PrivatePreferencesAction.encode(message.value, writer.uint32(18).fork()).ldelim();
        }
        return writer;
    },
    decode(input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                case 1:
                    ...
                    break;
                case 2:
                    message.value = private_preferences_pb_1.PrivatePreferencesAction.decode(reader, reader.uint32());
                    break;
                default:
                    reader.skipType(tag & 7);
                    break;
    ...
    fromJSON(object) {
        return {
            key: isSet(object.key) ? String(object.key) : "",
            value: isSet(object.value)
                ? private_preferences_pb_1.PrivatePreferencesAction.fromJSON(object.value)
                : undefined,
        };
    },
    toJSON(message) {
        ...
        message.value !== undefined &&
            (obj.value = message.value
                ? private_preferences_pb_1.PrivatePreferencesAction.toJSON(message.value)
                : undefined);
        return obj;
    },
    fromPartial(object) {
        ...
        message.value =
            object.value !== undefined && object.value !== null
                ? private_preferences_pb_1.PrivatePreferencesAction.fromPartial(object.value)
                : undefined;
        return message;
    },
};
