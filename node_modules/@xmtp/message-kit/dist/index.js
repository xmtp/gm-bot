...
async function logInitMessage(client, config, key, randomKey) {
...
Powered by XMTP \x1b[0m`;
    ...
    Warnings:`);
        ...
        if (randomKey) {
            console.warn(`\t- ⚠️🔒 Invalid private key or not set. Generating a random one.\n\t\t- Copy and paste it in your .env file as KEY=${key}`);
        }
        ...
        if (config?.experimental) {
            console.warn(`\t- ☣️ EXPERIMENTAL MODE ENABLED:\t\t⚠️ All group messages will be exposed — proceed with caution.\t\tℹ Guidelines: https://messagekit.ephemerahq.com/guidelines`);
        }
    }
    console.log(`━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
async function streamMessages(version, handleMessage, client) {
    let v3client = client;
    let v2client = client;
    while (true) {
        let stream;
...
async function run(handler, config) {
    ...
    const commandTriggered = (context) => {
        ...
        const skillGroup = typeId === "text" ? context?.findSkillGroup(content) : undefined; // Check if the message content triggers a tag
